    ...
    if not os.path.exists(MASTER_FILE_NAME):
        ...
        with st.spinner("Processing volume aggregation matrices and compiling visual worksheets..."):
            try:
                ...
                f_df = master_df[['Sub Division', 'Sub Office', 'Branch Office', 'Office ID', 'office-type-code']].copy()
                f_df.columns = ['Sub_Division', 'Sub_Office', 'Office_Name', 'Office_ID', 'Office_Type']
